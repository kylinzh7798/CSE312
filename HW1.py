...
class MyTCPHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        if content[0] == "POST " and content[1] == "image-upload HTTP":
            ...
            newUserID = "User" + str(random.randint(0, 1000))
            MyTCPHandler.websocket_connections.append(self)
            MyTCPHandler.ws_users[newUserID] = self
            ...
            while True:
                ...
                if len(recv_bytes) > 1:
                    ...
                    if recv_bytes[0] == 136:
                        print(recv_bytes)
                        print(newUserID," is disconnected ___________________________")
                        MyTCPHandler.websocket_connections.remove(MyTCPHandler.ws_users[newUserID])
                        MyTCPHandler.ws_users.pop(newUserID)
                    ...
                    #print(newUserID + " recv bytes: ",recv_bytes)
                    recv_bin = ""
                    ...
                    if payload_bin.find(offer_bin) == 0 or payload_bin.find(answer_bin) == 0 or payload_bin.find(cand_bin) == 0:
                        ...
                        if payload_len == 127:
                            ...
                            for k,v in MyTCPHandler.ws_users.items():
                                if k != newUserID:
                                    print(newUserID + " is sending to "+k)
                    ...
                    # if payload is chat message
                        ...
                        payload_msg["username"] = newUserID
                        #print(payload_msg)
